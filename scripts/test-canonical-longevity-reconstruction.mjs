...
assert.equal(report.controlCoverage,72,'The frozen canonical Longevity snapshot covers the same 72 fighters as the shared Era Ledger');
...
assert.equal(report.entryFor('Leon Edwards').currentScore,null,'Leon Edwards also lacks a frozen Longevity comparison control and must remain explicit');
