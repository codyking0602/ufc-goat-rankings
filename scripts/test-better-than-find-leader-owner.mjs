...
try{
  ...
  await productionPage.goto(`${ORIGIN}/index.html?phase5=find-leader-owner#home`,{waitUntil:'domcontentloaded',timeout:60000});
  await productionPage.waitForFunction(()=>window.UFC_FIND_LEADER&&document.documentElement.dataset.betterThanStandaloneShare,null,{timeout:60000});
  ...
  console.log('Better Than Find the Leader manifest ownership proof passed.');
}catch(error){
