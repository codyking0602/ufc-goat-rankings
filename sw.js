const VERSION='octagon-hq-sw-20260720b-canonical-picks-home';
const CACHE_NAME='octagon-hq-static-v9';
const LEGACY_PREFIX='octagon-hq-static-';
const CORE=['./','./index.html','./manifest.webmanifest'];
const FORCE_NETWORK=/\/assets\/(?:(?:js\/(?:app-notification-surface-fix|app-update-watcher|product-architecture|native-app-shell|native-app-shell-stability|community-profiles|fresh-home-launch|home-dashboard|find-leader|game-challenges|share-deep-links|picks-auto-advance)|data\/(?:what-changed|supabase-config|picks-events))\.js|css\/(?:native-app-shell|native-app-shell-stability|community-profiles|find-leader)\.css)$/i;
