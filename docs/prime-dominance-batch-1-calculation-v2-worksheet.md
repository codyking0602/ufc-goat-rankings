# Prime Dominance Batch 1 Calculation V2 Worksheet

Last updated: 2026-07-04

Purpose: recalculate Batch 1 after Cody approved two formula changes:
...
- `docs/prime-dominance-batch-1-calculation-worksheet.md`
...
- Consecutive title defenses still matter heavily.
- Khabib is not over-punished for having only 3 UFC title defenses.
- Division strength matters without turning into a multiplier that double-counts Opponent Quality.
- Dominating lightweight or GSP-era welterweight gets more credit than dominating a thinner division.
...
# Batch 1 V2 calculated scores

## Summary table

| Fighter | Current Prime | V1 Calculated | V2 Calculated | Change vs current | V2 main reason |
|---|---:|---:|---:|---:|---|
| Jon Jones | 27.20 | 27.30 | 27.20 | 0.00 | Elite record/safety/title streak; strong LHW/HW division score, but close late fights cap rounds. |
...
| 5 | Georges St-Pierre | 24.15 |
| 6 | Anderson Silva | 23.70 |
| 7 | Alexander Volkanovski | 22.30 |
| 8 | Max Holloway | 21.05 |

# Main model consequence

V2 fixes the Khabib problem without making the formula vibes-based.

The new shape makes sense:

- Khabib and Jon are the top Prime Dominance cases in this batch.
- DJ still gets massive credit for 11 defenses but is capped by flyweight strength.
- Amanda is just behind DJ because her peak finishing and 7 cross-belt defenses are huge, but Pena caps her.
- GSP gets strong WW/round-control credit but Serra keeps him below DJ/Amanda.
- Anderson rises a lot but is capped by Weidman + MW strength.
- Volk and Max rise because current scores overpunish later losses and undercredit modern FW difficulty.
...
Do not make Prime Dominance live until Batch 2 and the rest of the relevant top board are calculated under V2.