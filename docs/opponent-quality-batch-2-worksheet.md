...
Purpose: continue the next formula-only Opponent Quality pass after Batch 1B. No live app score changes are approved from this worksheet.
...
| Islam over Dustin | Cody says 1.00. Locked unless revisited. |
| Islam/Pereira current scoring-table timeline wins | Cody says yes. Include JDM for Islam and Ankalaev 2 for Pereira because they are already in the current scoring table. |
...
| Dustin Poirier | 1.00 | Cody call: full title-defense credit over still-dangerous elite lightweight |
| Renato Moicano | 0.50 | short-notice top-ten title challenger |
| Jack Della Maddalena | 1.25 | Cody call: include current scoring-table timeline sitting champion win |

Working math with Dustin at 1.00 and JDM included:
...
| Base OQ index | 8.25 |
| Division/era adjustment | 1.10 |
| Adjusted OQ index | 9.08 |
| Formula OQ score | 14.53 |
...
| Magomed Ankalaev 2 | 1.25 | Cody call: include current scoring-table timeline sitting champion win |
...
| Islam Makhachev | 9.80 | 14.53 | Raise |
...
1. Khabib: Iaquinta 0.50? Tibau/Tavares 0.25 each?
2. Islam: Moicano 0.50 or 0.25?
