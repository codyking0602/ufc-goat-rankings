...
DISPLAY_OVERRIDES into one generated app script.
"""
...
RANKING_SCRIPT_RE = re.compile(r'<script\s+src="assets/data/ranking-data-generated\.js[^>]*></script>', re.I)
DISPLAY_SCRIPT_RE = re.compile(r'<script\s+src="assets/data/display-overrides-generated\.js[^>]*></script>', re.I)
APP_SCRIPT_TAG = '  <script src="assets/js/app-generated.js?v=app-generated-20260701a"></script>'
...
def split_app_js(index_path: Path, output_path: Path) -> None:
    ...
    if not ranking_match:
        raise ValueError('Could not find generated ranking data script tag. Run split-ranking-data.py first.')

    display_match = DISPLAY_SCRIPT_RE.search(html)
    if not display_match:
        raise ValueError('Could not find generated display overrides script tag. Run split-display-overrides.py first.')
    ...
    output_path.write_text(
        '// Generated by tools/split-app-js.py during the Pages build.\n'
    ...
    # app chunk with the generated script tag. Do replacements from the end first so
    # earlier indexes remain valid.
