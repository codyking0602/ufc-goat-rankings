...
intact while moving app-facing profile polish into a generated data file during
build.
"""
...
def split_display_overrides(index_path: Path, output_path: Path) -> None:
    ...
    output_path.write_text(
        "// Generated by tools/split-display-overrides.py during the Pages build.\n"
    ...
    replacement = (
        "</script>\n"
        "  <script src=\"assets/data/display-overrides-generated.js?v=display-overrides-generated-20260701a\"></script>\n"
        "  <script>"
    )
