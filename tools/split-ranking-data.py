...
while moving the large ranking payload into a generated data file during build.
"""
...
def split_ranking_data(index_path: Path, output_path: Path) -> None:
    ...
    output_path.write_text(
        "// Generated by tools/split-ranking-data.py during the Pages build.\n"
    ...
    replacement = (
        "</script>\n"
        "  <script src=\"assets/data/ranking-data-generated.js?v=ranking-data-generated-20260701a\"></script>\n"
        "  <script>"
    )
