...
(function(){
  const VERSION='opponent-quality-division-calibration-batch-four-20260710d-dricus-omalley';
  ...
  store.batchFourDivisionCalibration={version:VERSION,changes,appliedAt:new Date().toISOString(),note:'Only Cejudo and Whittaker trims remain; Izzy over Pereira II is boosted to max credit. Batches five through eight, shadow audit, then category-only 30-point live scoring load after this file.'};
