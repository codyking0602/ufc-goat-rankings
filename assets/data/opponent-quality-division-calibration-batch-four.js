...
(function(){
  const VERSION='opponent-quality-division-calibration-batch-four-20260708b-approved-only';
  ...
  store.batchFourDivisionCalibration={version:VERSION,changes,appliedAt:new Date().toISOString(),note:'Only Cejudo and Whittaker trims remain; Izzy over Pereira II boosted to max credit. Usman, Alex, DC, Stipe, and Cain hard-division trims reverted.'};
