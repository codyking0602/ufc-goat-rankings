...
(function(){
  const VERSION='opponent-quality-division-calibration-batch-four-20260710a-category-only-live';
  ...
  store.batchFourDivisionCalibration={version:VERSION,changes,appliedAt:new Date().toISOString(),note:'Only Cejudo and Whittaker trims remain; Izzy over Pereira II boosted to max credit. Batches five, six, seven, shadow audit, then category-only 30-point live scoring load after this file.'};
  document.documentElement.setAttribute('data-opponent-quality-division-calibration-batch-four',VERSION);
  loadScriptOnce('assets/data/opponent-quality-ledger-batch-five.js?v=opponent-quality-ledger-batch-five-20260708b','data-opponent-quality-ledger-batch-five',()=>loadScriptOnce('assets/data/opponent-quality-ledger-batch-six.js?v=opponent-quality-ledger-batch-six-20260708a','data-opponent-quality-ledger-batch-six',()=>loadScriptOnce('assets/data/opponent-quality-ledger-batch-seven.js?v=opponent-quality-ledger-batch-seven-20260708a','data-opponent-quality-ledger-batch-seven',()=>loadScriptOnce('assets/js/opponent-quality-shadow-audit.js?v=opponent-quality-shadow-audit-20260708b','data-opponent-quality-shadow-audit',()=>loadScriptOnce('assets/js/opponent-quality-live.js?v=opponent-quality-live-20260710a-category-only','data-opponent-quality-live')))));
})();