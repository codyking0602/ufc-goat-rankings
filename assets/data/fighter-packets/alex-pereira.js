...
(function(){
  ...
  const packet = {
    ...
    display: {
      ...
      snapshot: [ ['UFC Record', '10-4'], ['UFC Title-Fight Wins', '5'], ['Championship Level', 'Two-Division UFC Champion'], ['Quality Wins', 'Compact High-Impact Win List'], ['Prime Record', 'Short Explosive Prime'], ['Active Elite Years', '3.6 Elite Years'], ['Loss Context', 'Adesanya and Gane finish losses cap the case'] ],
