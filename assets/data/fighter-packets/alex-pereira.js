...
(function(){
  const VERSION = 'fighter-packet-alex-pereira-20260710d-ufc-record';
  const fighter = 'Alex Pereira';

  const packet = {
    status: { stage: 'packet live; Watch Moment added; Gane loss updated; UFC record reconciled', lastUpdated: '2026-07-10', nextFix: 'Recalculate raw model score if Cody wants the base scoring table adjusted too.' },
    ...
    compareSeasoning: {
      ...
      legacyStats: { ufcRecord: '10-3', titleFightWins: 5, beltsWon: 2, titleDefenses: 3, activeEliteYearsLabel: 'roughly 4 active elite years', primeNote: 'short explosive two-division title run with Adesanya and Gane as counted UFC prime finish losses' }
    },
