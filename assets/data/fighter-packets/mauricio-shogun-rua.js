// Mauricio "Shogun" Rua presentation-only fighter packet.
(function(){
  'use strict';
  const VERSION='fighter-packet-mauricio-shogun-rua-20260716a-profile-copy-audit';
  ...
  const packet={
    ...
    display:{
      divisionLabel:'LHW',resumeTag:'Machida-slaying UFC champion',
      ...
      keyJudgmentCalls:[
        ['UFC-only scope','The historic PRIDE run is acknowledged as context but contributes no scoring credit.'],
        ['Machida I','The official decision loss remains a loss, while the disputed nature helps explain why the rematch carries such strong proof.'],
        ['Machida II','The knockout title win is the clear centerpiece of Rua’s UFC résumé and Apex score.'],
        ['Jon Jones','The title-loss stoppage is a real prime finish loss and sharply ends the championship peak.'],
        ['Later losses','Most of the heavy late-career damage is post-prime and does not receive the same penalty as the core Jones-era defeat.']
      ],
      finalTakeaway:'Shogun’s UFC-only case is a compact championship peak, not a complete career résumé. The Machida knockout is historically elite; the 11-12-1 UFC record and excluded PRIDE greatness explain why he ranks much lower here than on broader MMA lists.'
    }
  };
