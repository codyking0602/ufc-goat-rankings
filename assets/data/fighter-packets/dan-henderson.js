...
(function(){
  ...
  const packet = {
    status: { stage: 'permanent hand-added fighter; packet live; photos needed', lastUpdated: '2026-07-03', nextFix: 'Add Dan Henderson photos. Add Watch Moment only if Cody provides a URL.' },
    ...
    compareSeasoning: {
      ...
      weakness: 'No UFC undisputed title win, 8-8 UFC record, and too much greatness outside the scoring scope.',
      ...
      legacyStats: { ufcRecord: '8-8', titleFightWins: 0, beltsWon: 0, titleDefenses: 0, activeEliteYearsLabel: 'roughly 6 active elite UFC years', primeNote: 'UFC-only veteran elite window with major non-UFC legacy excluded' }
    },
    fightLedger: {
