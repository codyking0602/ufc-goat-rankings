...
(function(){
  ...
  const packet = {
    ...
    profileStats: { ufcRecord: '12-3', titleFightWins: 4, eliteWins: 5,  finishRatePct: 83.3, roundsWonPct: 77.8, activeEliteYears: 7.47, timesFinishedPrime: 2, divisionStrengthContext: 'Heavyweight volatility is acknowledged, while Cain gets strong credit for a historically dominant prime.', lossContext: 'JDS and Werdum losses matter, but injuries and heavyweight volatility provide context.' },
    compareSeasoning: {
