...
(function(){
  const VERSION = 'fighter-packet-valentina-shevchenko-20260702a';
  const fighter = 'Valentina Shevchenko';
  const packet = {
    status: { stage: 'packet live; photos and Watch Moment needed', lastUpdated: '2026-07-02', nextFix: 'Add Valentina photos and Watch Moment link.' },
    ...
    display: {
      ...
      snapshot: [ ['UFC Record', '14-4-1'], ['UFC Title-Fight Wins', '9'], ['Championship Level', 'Long Flyweight Reign'], ['Quality Wins', 'Deep Cross-Division Ledger'], ['Prime Record', 'Long Technical Prime'], ['Active Elite Years', '8.0 Elite Years'], ['Loss Context', 'Nunes rivalry and Grasso stretch cap the case'] ],
    ...
    compareSeasoning: {
      ...
      legacyStats: { ufcRecord: '14-4-1', titleFightWins: 9, beltsWon: 1, titleDefenses: 7, activeEliteYearsLabel: 'roughly 8 active elite years', primeNote: 'long technical flyweight title prime with strong bantamweight context' }
    }
  };
