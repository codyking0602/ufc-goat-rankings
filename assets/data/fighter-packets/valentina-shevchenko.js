...
(function(){
  ...
  const packet = {
    ...
    display: {
      ...
      snapshot: [ ['UFC Record', '14-4-1'], ['UFC Title-Fight Wins', '9'], ['Championship Level', 'Long Flyweight Reign'], ['Quality Wins', 'Deep Cross-Division Ledger'],  ['Active Elite Years', '8.0 Elite Years'], ['Loss Context', 'Nunes rivalry and Grasso stretch cap the case'] ],
