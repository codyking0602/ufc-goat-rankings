...
(function(){
  const VERSION = 'fighter-packet-charles-oliveira-20260702a';
  const fighter = 'Charles Oliveira';
  const packet = {
    status: { stage: 'packet live; photos and Watch Moment needed', lastUpdated: '2026-07-02', nextFix: 'Add Charles photos and Watch Moment link.' },
    ...
    display: {
      ...
      snapshot: [ ['UFC Record', '22-10, 1 NC'], ['UFC Title-Fight Wins', '3'], ['Championship Level', 'Short Lightweight Champion Run'], ['Quality Wins', 'Elite Lightweight Finish Ledger'], ['Prime Record', 'Late-Blooming Title Peak'], ['Active Elite Years', '4.0 Elite Years'], ['Loss Context', 'Early and prime losses create major drag'] ],
      ...
      keyJudgmentCalls: [ ['Quality wins', 'the biggest strength of the Charles case.'], ['Finish threat', 'central to his prime and why the resume feels so dangerous.'], ['Late-blooming prime', 'the scoring window protects the best lightweight run but cannot erase earlier damage.'], ['Islam loss', 'a real elite title loss that caps the lightweight supremacy case.'], ['Title volume', 'short reign keeps him below longer champions even with strong wins.'] ],
    ...
    profileStats: { ufcRecord: '22-10, 1 NC', titleFightWins: 3, eliteWins: 8, primeRecord: '8-2', finishRatePct: 86.4, roundsWonPct: 62.0, activeEliteYears: 4.0, timesFinishedPrime: 2, divisionStrengthContext: 'Lightweight strength is a major positive for his quality-win score.', lossContext: 'The record is messy, with early and title-level losses creating real drag.' },
    compareSeasoning: {
      ...
      legacyStats: { ufcRecord: '22-10, 1 NC', titleFightWins: 3, beltsWon: 1, titleDefenses: 1, activeEliteYearsLabel: 'roughly 4 active elite years', primeNote: 'late-blooming lightweight title peak with elite finishing value' }
    }
  };
