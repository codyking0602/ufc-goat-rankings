...
(function(){
  ...
  const packet = {
    ...
    display: {
      ...
      snapshot: [ ['UFC Record', '22-10, 1 NC'], ['UFC Title-Fight Wins', '3'], ['Championship Level', 'Short Lightweight Champion Run'], ['Quality Wins', 'Elite Lightweight Finish Ledger'],  ['Active Elite Years', '4.0 Elite Years'], ['Loss Context', 'Early and prime losses create major drag'] ],
