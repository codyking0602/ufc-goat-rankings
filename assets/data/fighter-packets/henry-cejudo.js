...
(function(){
  const VERSION = 'fighter-packet-henry-cejudo-20260710b-current-record';
  ...
  const packet = {
    ...
    display: {
      ...
      keyJudgmentCalls: [ ['Double-champ value', 'a major part of the case.'], ['DJ win', 'huge high-end flyweight value, even with close-fight context.'], ['Dillashaw and Moraes wins', 'make the title burst feel historically loud.'], ['Retirement gap', 'limits active elite longevity.'], ['Return losses', 'add record drag, but post-prime losses do not reduce the locked Loss Context score.'] ],
    ...
    profileStats: { ufcRecord: '10-6', titleFightWins: 4, eliteWins: 5, finishRatePct: 40.0, roundsWonPct: 63.5, activeEliteYears: 4.0, timesFinishedPrime: 1, divisionStrengthContext: 'Two-division value matters, with flyweight context adjusted and bantamweight value treated strongly.', lossContext: 'Sterling closes the counted prime window; Merab, Song, and Talbott are post-prime return losses.' },
    compareSeasoning: {
      ...
      legacyStats: { ufcRecord: '10-6', titleFightWins: 4, beltsWon: 2, titleDefenses: 2, activeEliteYearsLabel: 'roughly 4 active elite years', primeNote: 'compact achievement burst across flyweight and bantamweight' }
    }
  };
