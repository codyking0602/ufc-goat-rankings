...
(function(){
  ...
  const packet = {
    ...
    profileStats: { ufcRecord: '15-3, 1 NC', titleFightWins: 6, eliteWins: 9,  finishRatePct: 53.3, roundsWonPct: 74.6, activeEliteYears: 7.05, timesFinishedPrime: 2, divisionStrengthContext: 'Two-division UFC value helps, but both divisions have rivalry ceilings.', lossContext: 'Jones and Stipe losses are elite losses, but they meaningfully cap the all-time case.' },
    compareSeasoning: {
