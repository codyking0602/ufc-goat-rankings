...
(function(){
  ...
  const packet = {
    ...
    display: {
      ...
      snapshot: [ ['UFC Record', '6-2'], ['UFC Title-Fight Wins', '6'], ['Championship Level', 'Original Women’s BW Champion'], ['Quality Wins', 'Early Bantamweight Elite'], ['Prime Record', 'Short Violent Title Prime'], ['Active Elite Years', '3.0 Elite Years'], ['Loss Context', 'Holm and Nunes losses ended the case sharply'] ],
