...
(function(){
  const VERSION = 'fighter-packet-jose-aldo-20260702a';
  const fighter = 'Jose Aldo';

  const packet = {
    status: { stage: 'complete in packet system', lastUpdated: '2026-07-02', nextFix: 'None for Aldo. Continue mid-board packet cleanup.' },
    ...
    display: {
      ...
      snapshot: [ ['UFC Record', '14-9'], ['UFC Title-Fight Wins', '8 adjusted credit'], ['Championship Level', 'Historic Featherweight Champion'], ['Quality Wins', 'Deep Across Two Eras'], ['Prime Record', 'Elite Title-Reign Window'], ['Active Elite Years', '11.3 Elite Years'], ['Loss Context', 'Later losses mostly sit outside the core prime case'] ],
    ...
    profileStats: {
      ufcRecord: '14-9', titleFightWins: 5, adjustedTitleWins: 8, eliteWins: 8, primeRecord: '10-4', finishRatePct: 50.0, roundsWonPct: 64.8, activeEliteYears: 9.43, timesFinishedPrime: 1,
      divisionStrengthContext: 'UFC featherweight and bantamweight value is strong, but WEC greatness is historical context only.',
      lossContext: 'Later UFC losses create record drag, but much of the late stretch is treated outside the core prime case.'
    },
    compareSeasoning: {
