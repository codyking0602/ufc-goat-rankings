...
(function(){
  const VERSION = 'fighter-packet-dominick-cruz-20260716b-objective-stat-cleanup';
  const fighter = 'Dominick Cruz';
  const packet = {
    status: { stage: 'packet live; photos and Watch Moment needed', lastUpdated: '2026-07-16', nextFix: 'Add Cruz photos and Watch Moment link.' },
    ...
    display: {
      ...
      snapshot: [ ['UFC Record', '7-3'], ['UFC Title-Fight Wins', '4'], ['Championship Level', 'Fragmented UFC Champion'], ['Quality Wins', 'Dillashaw and DJ Anchor the Case'],  ['Active Elite Years', '5.51 Elite Years'], ['Loss Context', 'Injuries and late losses cap the case'] ],
    ...
    profileStats: { ufcRecord: '7-3', titleFightWins: 4, eliteWins: 5, finishRatePct: 14.29, roundsWonPct: 67.86, activeEliteYears: 5.51, timesFinishedPrime: 1, divisionStrengthContext: 'Bantamweight value is strong, but WEC accomplishments are context only.', lossContext: 'Late losses and injury gaps cap the all-time UFC-only case.' },
    compareSeasoning: {
      ...
      legacyStats: { ufcRecord: '7-3', titleFightWins: 4, beltsWon: 1, titleDefenses: 2, activeEliteYearsLabel: '5.51 active elite years', primeNote: 'brilliant but injury-fragmented prime with long gaps between elite wins' }
    }
  };
