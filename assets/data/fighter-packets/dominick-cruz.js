...
(function(){
  ...
  const packet = {
    ...
    display: {
      ...
      snapshot: [ ['UFC Record', '7-4'], ['UFC Title-Fight Wins', '3'], ['Championship Level', 'Fragmented UFC Champion'], ['Quality Wins', 'Dillashaw and DJ Anchor the Case'], ['Prime Record', 'Brilliant but Interrupted'], ['Active Elite Years', '5.0 Elite Years'], ['Loss Context', 'Injuries and late losses cap the case'] ],
    ...
    profileStats: { ufcRecord: '7-4', titleFightWins: 3, eliteWins: 4, primeRecord: '5-2', finishRatePct: 28.6, roundsWonPct: 66.0, activeEliteYears: 5.0, timesFinishedPrime: 1, divisionStrengthContext: 'Bantamweight value is strong, but WEC accomplishments are context only.', lossContext: 'Late losses and injury gaps cap the all-time UFC-only case.' },
    compareSeasoning: {
