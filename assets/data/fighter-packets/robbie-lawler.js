...
(function(){
  ...
  const boardRow={
    ...
    leaderboard:'men',gender:'Men',ufcRecord:'14-10, 1 NC',primaryDivision:'Welterweight',secondaryDivision:'Middleweight',finishRatePct:57.1,activeEliteYears:7.80,timesFinishedPrime:1,primeRecord:'8-2 comeback title window',roundsWonPct:54.0,
  ...
  const packet={
    ...
    display:{
      ...
      snapshot:[['UFC Record','14-10, 1 NC'],['UFC Title-Fight Wins','3'],['Apex Peak','+4.00'],['Quality Wins','Rory, Hendricks, Condit, Brown'],['Prime Window','Koscheck 2013 → Woodley 2016'],['Prime Dominance','15.95 / 30'],['Prime Record','8-2 comeback title window'],['Loss Context','-8.62']],
