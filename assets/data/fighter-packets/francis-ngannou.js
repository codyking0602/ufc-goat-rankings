...
(function(){
  ...
  const packet = {
    ...
    profileStats: { ufcRecord: '11-2', titleFightWins: 2, eliteWins: 7,  finishRatePct: 90.9, roundsWonPct: 66.0, activeEliteYears: 4.5, timesFinishedPrime: 0, divisionStrengthContext: 'Heavyweight power and volatility are part of the case, but title volume remains capped.', lossContext: 'Stipe and Lewis losses matter, while the later title run restores much of the profile.' },
    compareSeasoning: {
