...
(function(){
  const VERSION = 'fighter-packet-max-holloway-20260703b';
  const fighter = 'Max Holloway';

  const packet = {
    status: { stage: 'complete in packet system', lastUpdated: '2026-07-03', nextFix: 'Title-fight wins audited to literal UFC championship title-fight wins.' },
    repoLocations: {
    ...
    compareSeasoning: {
      ...
      opponentQuality: 'Holloway’s win depth is excellent: Aldo twice, Ortega, Kattar, Yair, Korean Zombie, Gaethje, and many more give him one of the strongest depth arguments in the ranking.',
      ...
      legacyStats: { ufcRecord: '23-9', titleFightWins: 4, beltsWon: 1, titleDefenses: 1, activeEliteYearsLabel: 'roughly 11 active elite years', primeNote: 'one of the longest elite windows in the ranking, with major value before and after the belt' }
    },
