...
(function(){
  ...
  const packet = {
    ...
    display: {
      ...
      snapshot: [ ['UFC Record', '10-4'], ['UFC Title-Fight Wins', '3'], ['Championship Level', 'First Simultaneous Double Champ'], ['Quality Wins', 'Aldo and Alvarez Anchor the Case'], ['Prime Record', 'Short Explosive Prime'], ['Active Elite Years', '3.0 Elite Years'], ['Loss Context', 'No defenses and later losses cap the resume'] ],
