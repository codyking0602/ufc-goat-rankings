...
(function(){
  ...
  const boardRow={
    ...
    leaderboard:'men',gender:'Men',ufcRecord:'4-3, 1 NC',primaryDivision:'Heavyweight',secondaryDivision:'',finishRatePct:75.0,activeEliteYears:2.70,timesFinishedPrime:1,primeRecord:'3-1 short title-run window',roundsWonPct:56.0,
  ...
  const packet={
    ...
    display:{
      ...
      snapshot:[['UFC Record','4-3, 1 NC'],['UFC Title-Fight Wins','3'],['Apex Peak','+4.60'],['Quality Wins','Couture, Mir, Carwin'],['Prime Window','Couture 2008 → Cain 2010'],['Prime Dominance','14.35 / 30'],['Prime Record','3-1 short title run'],['Loss Context','-3.75']],
    ...
    profileStats:{ufcRecord:'4-3, 1 NC',titleFightWins:3,adjustedTitleWins:2.40,eliteWins:2,primeRecord:'3-1 short title-run window',primeDominance:14.35,finishRatePct:75.0,roundsWonPct:56.0,activeEliteYears:2.70,apexPeak:4.60,timesFinishedPrime:1,divisionStrengthContext:'Heavyweight volatility lowers the cleanliness of the run, but UFC title wins over Couture, Mir, and Carwin still carry real value.',lossContext:'Mir I is early damage, Cain is the title-ending loss, Overeem is handled as health-exit/decline context, and Hunt is a no contest with no win credit.'},
