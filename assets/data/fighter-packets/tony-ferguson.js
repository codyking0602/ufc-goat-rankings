...
(function(){
  const VERSION='fighter-packet-tony-ferguson-20260706a';
  const fighter='Tony Ferguson';

  const rounds=[
    {opponent:'Michael Johnson',date:'2012-05-05',method:'Decision loss',roundsCounted:3,roundsWon:1,basis:'Pre-prime/early UFC loss to solid fighter',confidence:'Medium',notes:'Early/pre-prime damage only.'},
    ...
    {opponent:'Gleison Tibau',date:'2015-02-28',method:'Submission win R1',roundsCounted:1,roundsWon:1,basis:'Prime-gate veteran win',confidence:'High',notes:'Prime window begins around Tibau/Josh Thomson stretch.'},
    ...
    {opponent:'Kevin Lee',date:'2017-10-07',method:'Interim title win submission R3',roundsCounted:3,roundsWon:2,basis:'UFC interim lightweight title win',confidence:'High',notes:'0.75 adjusted title win.'},
    ...
    {opponent:'Justin Gaethje',date:'2020-05-09',method:'Interim title loss TKO R5',roundsCounted:5,roundsWon:1,basis:'Prime-ending title-level loss, finished',confidence:'High',notes:'Prime runs through Gaethje; counted as the title-level collapse point.'},
    {opponent:'Charles Oliveira',date:'2020-12-12',method:'Decision loss',roundsCounted:3,roundsWon:0,basis:'Post-prime elite loss',confidence:'High',notes:'Post-prime; no normal prime loss penalty.'},
    {opponent:'Beneil Dariush',date:'2021-05-15',method:'Decision loss',roundsCounted:3,roundsWon:0,basis:'Post-prime contender loss',confidence:'High',notes:'Post-prime.'},
    {opponent:'Michael Chandler',date:'2022-05-07',method:'KO loss R2',roundsCounted:2,roundsWon:1,basis:'Post-prime finished loss',confidence:'High',notes:'Post-prime; not a normal prime penalty.'},
    {opponent:'Nate Diaz',date:'2022-09-10',method:'Submission loss R4',roundsCounted:4,roundsWon:1,basis:'Post-prime short-notice/exit loss',confidence:'Medium',notes:'Post-prime.'},
    {opponent:'Bobby Green',date:'2023-07-29',method:'Submission loss R3',roundsCounted:3,roundsWon:0,basis:'Post-prime loss',confidence:'High',notes:'Post-prime.'},
    {opponent:'Paddy Pimblett',date:'2023-12-16',method:'Decision loss',roundsCounted:3,roundsWon:0,basis:'Post-prime loss',confidence:'Medium',notes:'Post-prime.'},
    {opponent:'Michael Chiesa',date:'2024-08-03',method:'Submission loss R1',roundsCounted:1,roundsWon:0,basis:'Post-prime loss',confidence:'High',notes:'Post-prime.'}
  ];
  ...
  const boardRow={
    ...
    leaderboard:'men',gender:'Men',ufcRecord:'15-9',primaryDivision:'Lightweight',secondaryDivision:'Welterweight',finishRatePct:66.7,activeEliteYears:8.85,timesFinishedPrime:1,primeRecord:'8-1 title-level prime window',roundsWonPct:58.5,
    notes:'Permanent fighter-packet add. Interim UFC lightweight champion and 12-fight-streak terror; prime runs through the Gaethje title-level loss, while Oliveira and later losses are post-prime.'
  };
  ...
  const profile={
    ...
    title:{normalTitleWins:0,interimTitleWins:1,adjustedTitleWins:0.75,notes:'UFC title-level wins = 1 interim. Kevin Lee interim lightweight title win = 0.75 adjusted title credit. Justin Gaethje interim/title-level loss adds no Championship credit.'},
    opponents:[
  ...
  const packet={
    ...
    display:{
      ...
      oneLiner:'A 12-fight-streak lightweight nightmare with interim-title value and elite prime dominance, capped by no undisputed belt and a brutal post-prime collapse.',
      ...
      snapshot:[['UFC Record','15-9'],['UFC Title-Fight Wins','1 interim / 0.75 adjusted'],['Apex Peak','+4.85'],['Quality Wins','RDA, Barboza, Lee, Pettis'],['Prime Window','Tibau/Thomson 2015 → Gaethje 2020'],['Prime Dominance','20.85 / 30'],['Prime Record','8-1 title-level window'],['Loss Context','-6.51']],
      whyRankedHere:'Ferguson scores as a high-respect, low-title-score legend because the 12-fight UFC win streak, interim title, and lightweight murderers’ row quality make his prime impossible to ignore.',
      whyNotHigher:'He does not rank higher because he never won an undisputed UFC title, never defended a UFC belt, and the Gaethje title-level loss is the point where the official champion case broke.',
      bigAssumptions:[['Interim title','Kevin Lee interim title win = 0.75 adjusted title credit.'],['Prime gate','Prime runs through Justin Gaethje because that was the title-level collapse point.'],['Post-prime losses','Oliveira and everything after are treated as post-prime/no normal prime penalty.'],['Division strength','Lightweight murderers’ row gets high division-strength respect.'],['Nickname','Profile-card display should show Tony “El Cucuy” Ferguson only after opening the profile.'],['Photos','No photo paths until real files exist in assets/fighters/.']],
      keyJudgmentCalls:[['Title limitation','The model rewards champion-level proof but does not pretend interim equals undisputed.'],['Gaethje treatment','The Gaethje loss is counted because it happened at the title-level prime gate.'],['Late skid','The brutal losing streak is not eight separate legacy-killing penalties.'],['Prime aura','Tony’s peak is elite because the streak and style made him a nightmare even without the official undisputed belt.']],
      apexPeakSummary:{score:4.85,window:'12-fight streak through interim title / Gaethje prime gate',components:{peakStatus:1.20,eliteOpponentProof:1.05,separationDominance:1.05,divisionStrength:1.00,cleanApexAura:0.55},notes:'Tony was not undisputed champion, but his peak lightweight danger, pace, durability, and streak created real uncrowned-champ aura.'},
    ...
    fightLedger:{
      ...
      'charles oliveira|tony ferguson':{fighters:['Charles Oliveira','Tony Ferguson'],fights:1,winner:'Charles Oliveira',importance:'notable',summary:'Oliveira dominated post-prime Tony, a major Charles proof point but not a normal prime penalty for Tony.'},
      'michael chandler|tony ferguson':{fighters:['Michael Chandler','Tony Ferguson'],fights:1,winner:'Michael Chandler',importance:'notable',summary:'Chandler’s front-kick KO came during Tony’s post-prime skid.'},
      'nate diaz|tony ferguson':{fighters:['Nate Diaz','Tony Ferguson'],fights:1,winner:'Nate Diaz',importance:'notable',summary:'Diaz submitted Tony in a short-notice/post-prime fight; useful rivalry/name context but not prime Tony scoring.'}
    }
  };
