...
(function(){
  ...
  const packet={
    ...
    display:{
      ...
      snapshot:[['UFC Record','15-9'],['UFC Title-Fight Wins','1 interim title win'],['Apex Peak','+4.85'],['Quality Wins','RDA, Barboza, Lee, Pettis'],['Prime Window','Tibau/Thomson 2015 → Gaethje 2020'],['Prime Dominance','20.85 / 30'],['Prime Record','8-1 title-level window'],['Loss Context','-6.51']],
    ...
    profileStats:{ufcRecord:'15-9',titleFightWins:1,adjustedTitleWins:0.75,eliteWins:3,primeRecord:'8-1 title-level prime window',primeDominance:20.85,finishRatePct:66.7,roundsWonPct:58.5,activeEliteYears:8.85,apexPeak:4.85,timesFinishedPrime:1,divisionStrengthContext:'Lightweight murderers’ row gives Tony’s streak and top wins extra weight.',lossContext:'Gaethje is the counted prime/title-level collapse point. Oliveira and later losses are decline-stage results.'},
