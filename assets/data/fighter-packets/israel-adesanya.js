...
(function(){
  ...
  const packet = {
    ...
    display: {
      ...
      snapshot: [ ['UFC Record', '14-5'], ['UFC Title-Fight Wins', '7'], ['Championship Level', 'Modern Middleweight Standard'], ['Quality Wins', 'Deep Modern MW Ledger'], ['Prime Record', 'Active Title-Heavy Prime'], ['Active Elite Years', '6.5 Elite Years'], ['Loss Context', 'Pereira, Strickland, and DDP losses drag the case'] ],
    ...
    profileStats: { ufcRecord: '14-5', titleFightWins: 7, eliteWins: 10, primeRecord: '12-4', finishRatePct: 42.9, roundsWonPct: 72.9, activeEliteYears: 6.54, timesFinishedPrime: 2, divisionStrengthContext: 'Modern middleweight quality is respected, with the light heavyweight attempt treated as context rather than the core case.', lossContext: 'Pereira, Strickland, and DDP losses matter, with Pereira also adding a redemption win.' },
    compareSeasoning: {
