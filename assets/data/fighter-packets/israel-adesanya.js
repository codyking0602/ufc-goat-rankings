...
(function(){
  const VERSION = 'fighter-packet-israel-adesanya-20260710b-current-record';
  const fighter = 'Israel Adesanya';

  const packet = {
    status: { stage: 'complete in packet system; current UFC record reconciled', lastUpdated: '2026-07-10', nextFix: 'None for Izzy. Continue current-roster packet cleanup.' },
    ...
    profileStats: { ufcRecord: '13-6', titleFightWins: 7, eliteWins: 10, finishRatePct: 42.9, roundsWonPct: 72.9, activeEliteYears: 6.54, timesFinishedPrime: 2, divisionStrengthContext: 'Modern middleweight quality is respected, with the light heavyweight attempt treated as context rather than the core case.', lossContext: 'Pereira, Strickland, and DDP losses matter in-prime; Imavov and Pyfer are post-prime context.' },
    compareSeasoning: {
      ...
      legacyStats: { ufcRecord: '13-6', titleFightWins: 7, beltsWon: 1, titleDefenses: 5, activeEliteYearsLabel: 'roughly 7 active elite years', primeNote: 'active modern middleweight title run with a major Pereira redemption win' }
    },
