...
(function(){
  ...
  const packet = {
    ...
    display: {
      ...
      snapshot: [ ['UFC Record', '15-5'], ['UFC Title-Fight Wins', '6'], ['Championship Level', 'UFC Heavyweight Standard'], ['Quality Wins', 'Best Heavyweight Win Stack'], ['Prime Record', 'Strong Heavyweight Prime'], ['Active Elite Years', '7.6 Elite Years'], ['Loss Context', 'Heavyweight volatility and late Jones loss matter'] ],
    ...
    profileStats: { ufcRecord: '15-5', titleFightWins: 6, eliteWins: 9, primeRecord: '11-4', finishRatePct: 80.0, roundsWonPct: 68.4, activeEliteYears: 7.62, timesFinishedPrime: 2, divisionStrengthContext: 'Heavyweight volatility is acknowledged, while Stipe still gets strong credit as the UFC heavyweight standard.', lossContext: 'Cormier and Ngannou losses matter, and the late Jones loss adds back-end context.' },
    compareSeasoning: {
