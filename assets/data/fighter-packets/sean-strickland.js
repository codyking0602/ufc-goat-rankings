...
(function(){
  ...
  const rounds = [
    { opponent:'Alex Garcia', date:'2017-05-13', method:'Decision', roundEnded:3, roundsCounted:3, roundsWon:2, basis:'Best-effort decision row', confidence:'Low', notes:'Early welterweight/pre-prime context.' },
    { opponent:'Court McGee', date:'2017-11-11', method:'Decision', roundEnded:3, roundsCounted:3, roundsWon:2, basis:'Best-effort decision row', confidence:'Low', notes:'Useful early UFC win.' },
    { opponent:'Tom Breese', date:'2018-05-27', method:'TKO', roundEnded:2, roundsCounted:2, roundsWon:1, basis:'Finish round counted; prior round treated conservatively', confidence:'Medium', notes:'' },
    { opponent:'Nordine Taleb', date:'2018-10-27', method:'TKO', roundEnded:2, roundsCounted:2, roundsWon:1, basis:'Finish round counted; prior round treated conservatively', confidence:'Medium', notes:'' },
    { opponent:'Kamaru Usman', date:'2017-04-08', method:'Decision Loss', roundEnded:3, roundsCounted:3, roundsWon:0, basis:'Pre-prime elite/champ-level decision loss', confidence:'Medium', notes:'Light loss-context treatment.' },
    { opponent:'Elizeu Zaleski dos Santos', date:'2018-05-12', method:'KO Loss', roundEnded:1, roundsCounted:1, roundsWon:0, basis:'Finished pre-prime loss', confidence:'High', notes:'Counts in loss context.' },
    { opponent:'Jack Marshman', date:'2020-10-31', method:'Decision', roundEnded:3, roundsCounted:3, roundsWon:3, basis:'Clear decision win', confidence:'Medium', notes:'' },
    { opponent:'Brendan Allen', date:'2020-11-14', method:'TKO', roundEnded:2, roundsCounted:2, roundsWon:1, basis:'Finish round counted; first round treated conservatively', confidence:'Medium', notes:'Quality win aged well.' },
    { opponent:'Krzysztof Jotko', date:'2021-05-01', method:'Decision', roundEnded:3, roundsCounted:3, roundsWon:2, basis:'Best-effort ranked decision row', confidence:'Medium', notes:'' },
    { opponent:'Uriah Hall', date:'2021-07-31', method:'Decision', roundEnded:5, roundsCounted:5, roundsWon:4, basis:'Main-event ranked decision win', confidence:'Medium', notes:'Elite-clock starter.' },
    { opponent:'Jack Hermansson', date:'2022-02-05', method:'Decision', roundEnded:5, roundsCounted:5, roundsWon:4, basis:'Ranked five-round decision win', confidence:'Medium', notes:'' },
    { opponent:'Alex Pereira', date:'2022-07-02', method:'KO Loss', roundEnded:1, roundsCounted:1, roundsWon:0, basis:'Prime finished loss to future champion/top-five opponent', confidence:'High', notes:'Major prime loss-context cap.' },
    { opponent:'Jared Cannonier', date:'2022-12-17', method:'Split Decision Loss', roundEnded:5, roundsCounted:5, roundsWon:2, basis:'Close top-contender decision loss', confidence:'Medium', notes:'Counts as elite decision loss but close context matters.' },
    { opponent:'Nassourdine Imavov', date:'2023-01-14', method:'Decision', roundEnded:5, roundsCounted:5, roundsWon:4, basis:'Short-notice five-round ranked win', confidence:'Medium', notes:'Quality win aged well.' },
    { opponent:'Abus Magomedov', date:'2023-07-01', method:'TKO', roundEnded:2, roundsCounted:2, roundsWon:1, basis:'Finish round counted; early round treated conservatively', confidence:'Medium', notes:'' },
    { opponent:'Israel Adesanya', date:'2023-09-10', method:'Decision', roundEnded:5, roundsCounted:5, roundsWon:5, basis:'Dominant title-winning decision over Adesanya', confidence:'High', notes:'Apex/title peak.' },
    { opponent:'Dricus du Plessis', date:'2024-01-20', method:'Split Decision Loss', roundEnded:5, roundsCounted:5, roundsWon:2, basis:'Close title loss to champion/top-five opponent', confidence:'Medium', notes:'Dricus direct-rivalry cap.' },
    { opponent:'Paulo Costa', date:'2024-06-01', method:'Decision', roundEnded:5, roundsCounted:5, roundsWon:4, basis:'Ranked five-round contender win', confidence:'Medium', notes:'' },
    { opponent:'Dricus du Plessis 2', date:'2025-02-09', method:'Decision Loss', roundEnded:5, roundsCounted:5, roundsWon:2, basis:'Title rematch loss to Dricus', confidence:'Low', notes:'Current-table / best-effort row until next full scoring rebuild.' },
    { opponent:'Khamzat Chimaev', date:'2026-02-14', method:'Decision', roundEnded:5, roundsCounted:5, roundsWon:3, basis:'Current-table title-level elite win', confidence:'Low', notes:'Current-table / best-effort row until next full scoring rebuild.' }
  ];
  ...
  function patchData(){ if(!window.RANKING_DATA) return; [...(window.RANKING_DATA.men || []), ...(window.RANKING_DATA.fighters || [])].forEach(row => { if(row?.fighter !== fighter) return; row.rounds = rounds; row.apexPeakAudit = packet.display.apexPeakSummary; }); }
