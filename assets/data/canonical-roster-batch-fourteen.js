...
(function(){
'use strict';
const VERSION='canonical-roster-batch-fourteen-20260717b-anthony-pettis-videos';
...
const record={
  ...
  primeWindow:{startFightId:'2012-02-25-joe-lauzon',endFightId:'2018-10-06-tony-ferguson',open:false,reviewStatus:'locked',note:'The ranked Joe Lauzon head-kick win begins Pettis’s connected elite and title run. Tony Ferguson closes the connected prime after the final Michael Chiesa rebound; the later Stephen Thompson knockout is an isolated post-prime elite win.'},
  ...
  fights:[
    ...
    fight({date:'2013-01-26',opponent:'Donald Cerrone',event:'UFC on Fox: Johnson vs. Dodson',method:'ko-tko',round:1,quality:'top-ten',rounds:R(1,0),championStatus:'contender',note:'High-value top-ten body-kick finish that secured the title path.'}),
    ...
    fight({date:'2017-11-11',opponent:'Dustin Poirier',event:'UFC Fight Night: Poirier vs. Pettis',result:'L',method:'ko-tko',round:3,quality:'top-ten',rounds:R(0,3),championStatus:'contender',note:'Prime finish loss to the officially top-ten contender who later became interim champion.'}),
    ...
    fight({date:'2018-10-06',opponent:'Tony Ferguson',event:'UFC 229: Khabib vs. McGregor',result:'L',method:'ko-tko',round:2,quality:'top-five',rounds:R(0,2),championStatus:'interim-champion',note:'Competitive prime elite corner-stoppage loss and connected-prime endpoint; the later Thompson knockout is treated as an isolated post-prime elite rebound.'}),
...
const judgments={
  ...
  opponentQuality:{benchmarkCredit:14.54,fighterAdjustment:0,inputs:[
    ...
    ['2013-01-26-donald-cerrone','Donald Cerrone',.85,'High-value top-ten lightweight finished in the first round.'],
...
const fightLedger={
  ...
  'anthony pettis|gilbert melendez':{fighters:[PETTIS,'Gilbert Melendez'],fights:1,winner:PETTIS,importance:'major',summary:'Pettis submitted Melendez with a second-round guillotine at UFC 181, becoming the first fighter to finish him and completing his only successful UFC title defense.'}
};
