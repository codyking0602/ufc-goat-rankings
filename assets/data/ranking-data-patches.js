...
(function(){
  const VERSION = 'ranking-data-patches-20260702r';
  ...
  function loadModules(){
    ...
    const loadCompareNarrative = () => loadScriptOnce('assets/js/compare-narrative-system.js?v=compare-narrative-system-20260702c', 'data-compare-narrative-system', loadCompareWatchdog);
