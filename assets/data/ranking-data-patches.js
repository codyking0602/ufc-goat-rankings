...
(function(){
  const VERSION = 'ranking-data-patches-20260702af-tight-compare-blocks';
  ...
  function loadModules(){
    ...
    const loadCompareNarrative=()=>loadScriptOnce('assets/js/compare-narrative-system.js?v=compare-narrative-system-20260702i','data-compare-narrative-system',loadCompareWatchdog);
  ...
  window.UFC_RANKING_DATA_PATCHES_V1={meta:{purpose:'Status hook, module loader, default fighter photo paths, and tight compare narrative loader',updated:'2026-07-02',version:VERSION},apply:status,slugFor};
  installImageFallback();
