...
(function(){
  const VERSION = 'ranking-data-patches-20260702ak-fighter-packets';
  ...
  window.UFC_RANKING_DATA_PATCHES_V1={meta:{purpose:'Status hook, module loader, default fighter photo paths, compare verdict clarity loader, and central fighter packet loader',updated:'2026-07-02',version:VERSION},apply:status,slugFor};
  installImageFallback();
