...
(function(){
  const VERSION='ranking-data-patches-20260705s-category-leaders-clean-rows';
  ...
  window.UFC_RANKING_DATA_PATCHES_V1={meta:{purpose:'Status hook and module loader with clean Category Leaders rows, fluid Apex-aware division rankings, visible Apex Peak rating card, and score weighting',updated:'2026-07-05',version:VERSION},apply:status,slugFor,syncPacketProfileStats};
  installImageFallback();
