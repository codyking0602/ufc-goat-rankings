...
(function(){
  const VERSION = 'ranking-data-patches-20260702c';
  ...
  function loadModules(){
    const loadHomePolish = () => loadScriptOnce('assets/js/home-polish.js?v=home-polish-20260702b', 'data-home-polish', status);
