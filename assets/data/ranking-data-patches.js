...
(function(){
  const VERSION='ranking-data-patches-20260705t-packet-manifest-loader';
  ...
  function loadModules(){
    ...
    const loadPacketManifest=()=>loadScriptOnce('assets/data/fighter-packet-manifest.js?v=fighter-packet-manifest-20260705a','data-fighter-packet-manifest',loadCompareCore);
