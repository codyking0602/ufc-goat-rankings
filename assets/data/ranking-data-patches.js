...
(function(){
  const VERSION = 'ranking-data-patches-20260702i';
  ...
  function loadModules(){
    const loadDivisionRankings = () => loadScriptOnce('assets/js/division-rankings.js?v=division-rankings-20260702c', 'data-division-rankings', status);
