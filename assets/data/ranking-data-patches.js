...
(function(){
  const VERSION='ranking-data-patches-20260705j-apex-batch-2-live';
  ...
  window.UFC_RANKING_DATA_PATCHES_V1={meta:{purpose:'Status hook and module loader with explicit division boards, visible Apex Peak category card, Apex Peak batch 2, score weighting, Longevity, and Penalty corrections',updated:'2026-07-05',version:VERSION},apply:status,slugFor,syncPacketProfileStats};
  installImageFallback();
