...
(function(){
  'use strict';
  const VERSION='ranking-data-patches-20260711s-signature-fights-batch-three';
  ...
  function loadModules(){
    ...
    const loadWatchMoments=()=>loadScriptOnce('assets/js/watch-moments.js?v=watch-moments-20260711e-signature-fights-batch-three','data-watch-moments',loadHomePolish);
