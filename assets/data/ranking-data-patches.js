...
(function(){
  const VERSION='ranking-data-patches-20260705m-apex-batch-4-live';
  ...
  window.UFC_RANKING_DATA_PATCHES_V1={meta:{purpose:'Status hook and module loader with explicit division boards, visible Apex Peak rating card, Apex Peak batch 4, score weighting, Longevity, and Penalty corrections',updated:'2026-07-05',version:VERSION},apply:status,slugFor,syncPacketProfileStats};
  installImageFallback();
