...
(function(){
  const VERSION='ranking-data-patches-20260705c-division-no-ratings';
  ...
  window.UFC_RANKING_DATA_PATCHES_V1={meta:{purpose:'Status hook and module loader with no-visible-rating division boards',updated:'2026-07-05',version:VERSION},apply:status,slugFor,syncPacketProfileStats};
  installImageFallback();
