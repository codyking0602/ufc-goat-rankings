...
(function(){
  'use strict';
  const VERSION='ranking-data-patches-20260711r-signature-fights-batch-two';
  ...
  function loadModules(){
    ...
    const loadWatchMoments=()=>loadScriptOnce('assets/js/watch-moments.js?v=watch-moments-20260711d-signature-fights-batch-two','data-watch-moments',loadHomePolish);
