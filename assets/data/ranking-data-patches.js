...
(function(){
  const VERSION = 'ranking-data-patches-20260702n';
  ...
  function loadModules(){
    const loadBranding = () => loadScriptOnce('assets/js/app-branding.js?v=app-branding-20260702b', 'data-app-branding', status);
