...
await loadStep('loss-context-adapter-refresh',cache('assets/data/loss-context-ledger-adapter.js',`loss-context-ledger-adapter-${v.lossContextAdapterRefresh}`),'data-loss-context-ledger-adapter-batch-five');
await loadStep('loss-context-live-refresh',cache('assets/data/loss-context-live-promoter.js',`loss-context-live-promoter-${v.lossContextLiveRefresh}`),'data-loss-context-live-promoter-batch-five');
