...
window.UFC_MODULE_VERSIONS={scoringPipeline:"20260710zc-loss-context-final-closure",finalScoreEngine:"20260710b-deterministic",primeWindows:"20260710b-context-only",primeRoundControlAudit:"20260708d-jon-54-63",primeDominanceLedgers:"20260708j-round-audit-batch-two",primeDominanceShadowModel:"20260708c-jon-elite-stakes",primeDominanceAuditBatchSeven:"20260710d-frankie-full-window",primeDominanceAuditBatchTen:"20260710a-canonical-window-five",primeDominanceLivePromoter:"20260710d-canonical-prime-source",primeDominanceCopyPolish:"20260708b",categoryPercentileTiers:"20260710c-rating-source",scoreWeighting:"20260710a-compatibility-only",championshipResumeLive:"20260710d-fixed-benchmark",opponentQualityLive:"20260710c-fixed-benchmark",fighterEraLedgers:"20260709g-review-corrections",canonicalPrimeRecords:"20260710b-prime-ledger-recount",fighterEraWindowAudit:"20260710b-record-dependencies",lossContextMismatchAudit:"20260710c-exact-official-loss-reconciliation",lossContextLedgerFinalizer:"20260710a-record-bucket-reconciliation",lossContextScoreReview:"20260710a-canonical-ledger-promotion",lossContextFinalReport:"20260710a-runtime-closure",lossContextFlaggedList:"20260710g-batch-seven-complete-roster",lossContextCompletionBatchThree:"20260710a-five-veteran-ledgers",lossContextCompletionBatchFour:"20260710a-five-highest-missing",lossContextCompletionBatchFive:"20260710a-ten-veteran-ledgers",lossContextCompletionBatchSix:"20260710a-first-half-eighteen",lossContextCompletionBatchSeven:"20260710a-final-seventeen",lossContextAdapterRefresh:"20260710g-batch-seven-refresh",lossContextLiveRefresh:"20260710g-canonical-score-review",longevityCanonicalRecalculation:"20260710a-ten-window-rebuild",longevityShadowScorer:"20260710c-144-month-ceiling",longevityLivePromoter:"20260710b-144-month-ceiling",apexPeakCorrections:"20260709b-full-roster",apexPeakComponentAudit:"20260709c-batch-one-review-adjustments",apexPeakLiveBonus:"20260710a-category-only",apexPeakDricusAudit:"20260710b-merab-zhang"};
(function(){
'use strict';
const v=window.UFC_MODULE_VERSIONS||{},VERSION='deterministic-scoring-pipeline-20260710zc-loss-context-final-closure';
...
await loadStep('loss-context-ledger-finalizer',cache('assets/data/loss-context-ledger-finalizer.js',`loss-context-ledger-finalizer-${v.lossContextLedgerFinalizer}`),'data-loss-context-ledger-finalizer');
state.lossContextLedgerFinalizer=window.UFC_LOSS_CONTEXT_LEDGER_FINALIZER||null;
await loadStep('loss-context-adapter-refresh',cache('assets/data/loss-context-ledger-adapter.js',`loss-context-ledger-adapter-${v.lossContextAdapterRefresh}`),'data-loss-context-ledger-adapter-score-review');
await loadStep('loss-context-mismatch-audit-pre',cache('assets/data/loss-context-mismatch-audit.js',`loss-context-mismatch-audit-${v.lossContextMismatchAudit}-pre`),'data-loss-context-mismatch-audit-pre');
state.lossContextPrePromotionAudit=window.UFC_LOSS_CONTEXT_MISMATCH_AUDIT||null;
await loadStep('loss-context-score-review',cache('assets/data/loss-context-score-review.js',`loss-context-score-review-${v.lossContextScoreReview}`),'data-loss-context-score-review');
state.lossContextScoreReview=window.UFC_LOSS_CONTEXT_SCORE_REVIEW||null;
await loadStep('loss-context-live-refresh',cache('assets/data/loss-context-live-promoter.js',`loss-context-live-promoter-${v.lossContextLiveRefresh}`),'data-loss-context-live-promoter-score-review');
state.lossContextLive=window.UFC_LOSS_CONTEXT_LIVE_PROMOTER||null;
await loadStep('loss-context-mismatch-audit-post',cache('assets/data/loss-context-mismatch-audit.js',`loss-context-mismatch-audit-${v.lossContextMismatchAudit}-post`),'data-loss-context-mismatch-audit-post');
state.lossContextMismatchAudit=window.UFC_LOSS_CONTEXT_MISMATCH_AUDIT||null;
await loadStep('loss-context-flagged-list',cache('assets/data/loss-context-flagged-fighter-list.js',`loss-context-flagged-fighter-list-${v.lossContextFlaggedList}`),'data-loss-context-flagged-fighter-list');
state.lossContextFlaggedFighters=window.UFC_LOSS_CONTEXT_FLAGGED_FIGHTERS||null;
...
await loadStep('loss-context-final-report',cache('assets/data/loss-context-final-reconciliation-report.js',`loss-context-final-reconciliation-report-${v.lossContextFinalReport}`),'data-loss-context-final-reconciliation-report');
state.lossContextFinalReconciliation=window.UFC_LOSS_CONTEXT_FINAL_RECONCILIATION||null;
