...
(function(){
  ...
  function tunePrimeDominance(){
    ...
    if(!base || !base.entryFor || base.tuningVersion === '20260708d') return;
    ...
    const extraRaw = {
      ...
      'Khamzat Chimaev': {primeRecord:'6-0',primeWins:6,primeLosses:0,primeDraws:0,primeNCs:0,roundControlPct:87.5,roundsWon:14,roundsCounted:16,primeFights:6,primeFinishes:4,profile:'Active control-heavy prime with huge wrestling separation but short sample',status:'review'},
    ...
    function tunedEntryFor(fighter){
      ...
      return {...entry, finishPressureScore: fs, eliteStakesBreakdown: eb, eliteStakesRawScore: er, eliteStakesScore: es, total: round(Number(entry.primeRecordScore||0)+Number(entry.roundControlScore||0)+fs+es), version: 'prime-dominance-tuned-20260708d'};
    }
    ...
    base.eliteStakesBreakdowns = {...(base.eliteStakesBreakdowns || {}), ...override, ...extraElite}; base.extraRawBatchFive = extraRaw; base.tuningVersion = '20260708d'; base.mode = 'shadow-finish-scale-batch-five-men'; base.applied = applyTuned();
    window.UFC_PRIME_DOMINANCE_TUNING_PATCH = {version:'20260708d',batchFive:Object.keys(extraRaw)};
