...
window.UFC_MODULE_VERSIONS={scoringPipeline:"20260710w-loss-context-batch-three",finalScoreEngine:"20260710b-deterministic",primeWindows:"20260710b-context-only",primeRoundControlAudit:"20260708d-jon-54-63",primeDominanceLedgers:"20260708j-round-audit-batch-two",primeDominanceShadowModel:"20260708c-jon-elite-stakes",primeDominanceAuditBatchSeven:"20260710d-frankie-full-window",primeDominanceAuditBatchTen:"20260710a-canonical-window-five",primeDominanceLivePromoter:"20260710d-canonical-prime-source",primeDominanceCopyPolish:"20260708b",categoryPercentileTiers:"20260710c-rating-source",scoreWeighting:"20260710a-compatibility-only",championshipResumeLive:"20260710d-fixed-benchmark",opponentQualityLive:"20260710c-fixed-benchmark",fighterEraLedgers:"20260709g-review-corrections",canonicalPrimeRecords:"20260710b-prime-ledger-recount",fighterEraWindowAudit:"20260710b-record-dependencies",lossContextMismatchAudit:"20260710a-roster-62",lossContextFlaggedList:"20260710c-batch-three-priority-queue",lossContextCompletionBatchThree:"20260710a-five-veteran-ledgers",lossContextAdapterRefresh:"20260710c-batch-three-refresh",lossContextLiveRefresh:"20260710b-batch-three-refresh",longevityCanonicalRecalculation:"20260710a-ten-window-rebuild",longevityShadowScorer:"20260710c-144-month-ceiling",longevityLivePromoter:"20260710b-144-month-ceiling",apexPeakCorrections:"20260709b-full-roster",apexPeakComponentAudit:"20260709c-batch-one-review-adjustments",apexPeakLiveBonus:"20260710a-category-only",apexPeakDricusAudit:"20260710b-merab-zhang"};
(function(){
'use strict';
const v=window.UFC_MODULE_VERSIONS||{},VERSION='deterministic-scoring-pipeline-20260710w-loss-context-batch-three';
...
await loadStep('loss-context-adapter-refresh',cache('assets/data/loss-context-ledger-adapter.js',`loss-context-ledger-adapter-${v.lossContextAdapterRefresh}`),'data-loss-context-ledger-adapter-batch-three');
await loadStep('loss-context-live-refresh',cache('assets/data/loss-context-live-promoter.js',`loss-context-live-promoter-${v.lossContextLiveRefresh}`),'data-loss-context-live-promoter-batch-three');
