...
window.UFC_MODULE_VERSIONS={scoringPipeline:"20260710g-apex-components-complete",finalScoreEngine:"20260710b-deterministic",primeWindows:"20260708a",primeRoundControlAudit:"20260708d-jon-54-63",primeDominanceLedgers:"20260708j-round-audit-batch-two",primeDominanceShadowModel:"20260708c-jon-elite-stakes",primeDominanceAuditBatchSeven:"20260710c-prime-final-batch",primeDominanceLivePromoter:"20260710a-category-only",primeDominanceCopyPolish:"20260708b",categoryPercentileTiers:"20260710b-deterministic",scoreWeighting:"20260710a-compatibility-only",championshipResumeLive:"20260710c-quality-revisions",opponentQualityLive:"20260710b-ready-gate",fighterEraLedgers:"20260709g-review-corrections",longevityShadowScorer:"20260709b-ledger-driven",longevityLivePromoter:"20260710a-category-only",apexPeakCorrections:"20260709b-full-roster",apexPeakComponentAudit:"20260709c-batch-one-review-adjustments",apexPeakLiveBonus:"20260710a-category-only",apexPeakDricusAudit:"20260710b-merab-zhang"};
(function(){
'use strict';
const v=window.UFC_MODULE_VERSIONS||{},VERSION='deterministic-scoring-pipeline-20260710g-apex-components-complete';
