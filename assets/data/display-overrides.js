...
const DISPLAY_OVERRIDES = {
  ...
  "Georges St-Pierre": {
    ...
    "keyJudgmentCalls": [
      ...
      [
        ...
        "is the clearest strength of the GSP case and the best in this ranking's current data."
      ],
      [
        "Late-career sample",
  ...
  "Jose Aldo": {
    ...
    "keyJudgmentCalls": [
      ...
      [
        "Longevity",
        "is the clear strength of the Aldo profile and one of the best scores in this ranking."
      ],
      [
        "Interim title",
        "the UFC 200 interim win adds partial championship credit."
      ],
      [
        "Post-prime stretch",
        "the bantamweight resurgence helps longevity even though late losses are less damaging."
      ],
      [
        "Prime dominance",
        "sits lower than fans may expect, which is why his total rank lands outside the top ten here."
      ]
    ],
