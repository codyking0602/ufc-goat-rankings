...
(function(){
  ...
  function updateSnapshot(name,report,score){
    ...
    o.snapshotStats.titleFightWins=report.titleFightWins;o.snapshotStats.adjustedTitleWins=r(report.adjustedTitleCredit);o.snapshotStats.championshipScore=score;
  ...
  loadProfilePolish();loadOpponentQualityShadow();applyFinalScore('championship-resume-category-update');
