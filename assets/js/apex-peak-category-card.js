...
(function(){
  const VERSION = 'apex-peak-category-card-20260706b-category-leaders';
  const APEX_MAX = 6;
  ...
  function loadCategoryLeaders(){
    ...
    script.src = 'assets/js/category-leaders.js?v=category-leaders-20260706b-championship-audit';
