(function(){
  ...
  const VERSION='product-architecture-20260718h-profile-final';
  ...
  const AVATAR_SYNC_SRC='assets/js/profile-avatar-sync.js?v=profile-avatar-sync-20260718b-resolved';
