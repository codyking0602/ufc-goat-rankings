// Compare Mode narrative copy and real direct-fight ledger. Calculated stats are injected from RANKING_DATA at runtime.
(function(){
  'use strict';
  ...
  "jose aldo|max holloway": {
    ...
    "winner": "Max Holloway",
    "importance": "major",
    "summary": "Holloway finished Aldo twice in featherweight title fights, which gives Max clear separation even though Aldo's broader historical legacy remains massive."
  },
  "alexander volkanovski|max holloway": {
    ...
    "importance": "major",
    "summary": "Volkanovski beat Holloway three times, took the featherweight belt from him, and owned the clearest separation of their shared era."
  },
  ...
  "conor mcgregor|max holloway": {
    ...
    "summary": "Conor beat a young Holloway in 2013. That matters historically, but Max later built a much deeper long-term resume, so that fight does not automatically decide the all-time ranking."
  },
  "conor mcgregor|jose aldo": {
    ...
    "winner": "Conor McGregor",
    "importance": "major",
    "summary": "Conor knocked out Aldo in 13 seconds, one of the biggest legacy moments in UFC history. Aldo still has the larger long-term featherweight legacy, but that result is impossible to ignore."
  },
  "conor mcgregor|khabib nurmagomedov": {
    ...
    "importance": "major",
    "summary": "Khabib submitted Conor in their lightweight title fight, which gives Khabib clear separation in one of the most important fights of the modern era."
  },
  "demetrious johnson|henry cejudo": {
    ...
    "winner": "Split",
    "importance": "major",
    "summary": "DJ finished Cejudo in their first fight, then Cejudo edged the rematch to win the flyweight title. The split series keeps the debate nuanced instead of one-sided."
  },
  ...
  "jose aldo|frankie edgar": {
    ...
    "winner": "Jose Aldo",
    "importance": "major",
    "summary": "Aldo beat Edgar twice in UFC featherweight title-level fights, which is a major part of Aldo's UFC resume."
  },
